...
public class Formula7Servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Formula7Servlet.from_a = from_a;
            Formula7Servlet.from_b = from_b;
            Formula7Servlet.from_c = from_c;
            Formula7Servlet.from_d = from_d;
            Formula7Servlet.to_a = to_a;
            Formula7Servlet.to_b = to_b;
            Formula7Servlet.to_c = to_c;
            Formula7Servlet.to_d = to_d;
            Formula7Servlet.step_a = step_a;
            Formula7Servlet.step_b = step_b;
            Formula7Servlet.step_c = step_c;
            Formula7Servlet.step_d = step_d;
            ...
            request.setAttribute("numOfFormula", 7);
            ...
            try(PrintWriter out = response.getWriter()) {
                ...
                out.println("<input name=\"numOfFormula\" type=\"hidden\" value=\"7\">");
