...
public class Formula9Servlet extends HttpServlet {
    ...
    private double calculate(double a, double b, double c, double d) {
        double answer = (sin(abs(a)) + cos(sqrt(b))) / (2 * tan(c) + exp(d));
        return answer;
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Formula9Servlet.from_a = from_a;
            Formula9Servlet.from_b = from_b;
            Formula9Servlet.from_c = from_c;
            Formula9Servlet.from_d = from_d;
            Formula9Servlet.to_a = to_a;
            Formula9Servlet.to_b = to_b;
            Formula9Servlet.to_c = to_c;
            Formula9Servlet.to_d = to_d;
            Formula9Servlet.step_a = step_a;
            Formula9Servlet.step_b = step_b;
            Formula9Servlet.step_c = step_c;
            Formula9Servlet.step_d = step_d;
            ...
            request.setAttribute("numOfFormula", 9);
            ...
            try(PrintWriter out = response.getWriter()) {
                ...
                out.println("<input name=\"numOfFormula\" type=\"hidden\" value=\"9\">");
